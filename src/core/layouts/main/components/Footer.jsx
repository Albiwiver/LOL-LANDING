import { footerLinks } from "../../../router/routes/routes";
import { serviceLinks } from "../../../router/routes/routes";
  ...
  return (
    <>
      <div className="w-full h-auto flex flex-col">
        <div className="w-full h-auto flex flex-col p-6 font-bold text-center uppercase bg-[#292929]">
          <ul className="flex flex-col items-center justify-center list-none md:flex-row flex-wrap">
            {footerLinks.map((item, index) => (
              <>
                <li className="list-none w-full md:w-auto h-8 text-center text-white my-2 lg:my-0">
                  <a
                    key={index}
                    href=""
                    className="px-4 text-sm py-2 hover:bg-[#313131] rounded-lg"
                  >
                    {item.title}
                  </a>
                </li>
        ...
        <div className="w-full h-auto bg-[#111111] flex flex-col">
          <div className="w-full h-auto flex justify-center items-center my-7">
            <ul className="w-auto flex-wrap h-auto flex justify-center items-center gap-3 text-white">
              <li className="p-2.5 lg:p-1.5 bg-[#282828] w-auto rounded-xl  h-auto">
                <a href="">{<FaYoutube className="size-7 lg:size-5" />}</a>
              </li>
              <li className="p-2.5 lg:p-1.5 bg-[#282828] w-auto rounded-xl  h-auto">
                <a href="">{<FaYoutube className="size-7 lg:size-5" />}</a>
              </li>
              <li className="p-2.5 lg:p-1.5 bg-[#282828] w-auto rounded-xl  h-auto">
                <a href="">{<FaFacebook className="size-7 lg:size-5" />}</a>
              </li>
              <li className="p-2.5 lg:p-1.5 bg-[#282828] w-auto rounded-xl  h-auto">
                <a href="">{<FaInstagram className="size-7 lg:size-5" />}</a>
              </li>
              <li className="p-2.5 lg:p-1.5 bg-[#282828] w-auto rounded-xl  h-auto">
                <a href="">{<BsReddit className="size-7 lg:size-5" />}</a>
              </li>
              <li className="p-2.5 lg:p-1.5 bg-[#282828] w-auto rounded-xl  h-auto">
                <a href="">{<IoLogoDiscord className="size-7 lg:size-5" />}</a>
              </li>
            </ul>
          </div>

          <div className="w-full h-auto cursor-pointer flex py-4 justify-center items-center">
          ...
          <p className="text-[#7e7e7e] text-center text-[13px] px-12  m-auto max-w-xl">
            ™ & © 2025 Riot Games, Inc. Todos los derechos reservados. Riot
            Games, League of Legends y PvP.net son marcas comerciales o marcas
            registradas de Riot Games, Inc.
          </p>
          <div className="w-full h-auto flex flex-col p-6 font-bold text-center uppercase">
            <ul className="flex flex-col items-center justify-center list-none md:flex-row flex-wrap">
